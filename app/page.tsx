export default function HomePage() {
  return (
    <main style={{ padding: '2rem', fontFamily: 'Arial', lineHeight: 1.6 }}>
      <h1>Welcome to T21 AI Platform</h1>
      <p>
      ...
      <ul>
        ...
        <li>🤖 <strong>AI Assistant:</strong> Coming soon — 24/7 smart guidance for NHS roles, remote jobs, visa guidance, and interview prep.</li>
      ...
      <h2>🔗 Learn More</h2>
      <p>Visit <a href="https://www.t21services.co.uk" target="_blank">T21 Services UK</a> and <a href="https://auglobalgateway.org" target="_blank">AU Gateway Global CIC</a></p>
    </main>
  );
}
